...
<template>
  <nav
    class="flex h-full w-13 shrink-0 flex-col items-center border-r border-[#e0e0e0] bg-[#f4f4f4] py-2"
    aria-label="Primary"
  >
    <img src="/logo.png" alt="Akhtabooti" class="mb-2 h-6 w-6 shrink-0 object-contain" />
    <div class="mb-2 h-px w-8 shrink-0 bg-[#e0e0e0]" aria-hidden="true" />
